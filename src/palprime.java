...
public class palprime {
    ...
    static void Mangni_ke_bail_ke_dant_na_dekhal_jye() {
        TreeSet <String> set = new TreeSet<>((String a,String b)->a.length()==b.length()?a.compareTo(b):a.length()-b.length());
        set.add(1+"");
        for(int i=3;i<=1<<22;i++){
            if(checkPrime(i) && checkPallindrome(i))set.add(Integer.toBinaryString(i));
        }
